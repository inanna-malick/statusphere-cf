CREATE TABLE IF NOT EXISTS "status" ("uri" varchar primary key, "authorDid" varchar not null, "status" varchar not null, "createdAt" varchar not null, "indexed_us" bigint not null );
